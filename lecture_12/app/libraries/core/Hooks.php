...
if (!class_exists('Hooks')) {
    ...
    class Hooks {
        ...
        /**
         * Returns the Hook class instance.
         * Prevents multiple instancing
         * @return Hook
         */
        static function instance() {
            if (!self::$_instance instanceof Hooks) {
        ...
        /**
         * Prevents the class from beeing cloned
         * @throws \Exception
         */
        function __clone() {
            throw new \Exception('The Hook object cannot be cloned!');
        }
